//title world map
current_level = ds_map_find_value(level_map , "start");

// attributes for shape world level
ds_map_add(current_level, "scrolling_level", false);
ds_map_add(current_level, "level_name", "start");
...
ds_map_add(current_object, "depth", -140 );
...
ds_map_add(current_object, "depth", -160 );

ds_map_add(current_object, "type", "set" );
ds_map_add(current_object, "x_position", room_width*3/4);
...
ds_map_add(current_object, "depth", -180 );
